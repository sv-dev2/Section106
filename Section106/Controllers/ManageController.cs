...
namespace Section106.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ManageController(ApplicationUserManager userManager, ApplicationSignInManager signInManager, ICommonService CommonService, IUserService UserService)
        {
        ...
        public ActionResult Index(ManageMessageId? message)
        {
            ...
            contactVM = _userService.GetSubmittingContactByUserId(loggedInUserId);

            contactVM.States = _commonService.GetStates();
            contactVM.Cities = _commonService.GetCities();
            contactVM.Counties = _commonService.GetCounties();
